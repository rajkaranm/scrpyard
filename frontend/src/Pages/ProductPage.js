...
export default function ProductPage({user, setUser}) {
    ...
    useEffect(() => {
        async function fetchData() {
            const req = await axios.get(`http://localhost:5000/product/id/${id}`);
    ...
    const addToCart = async (e) => {
        ...
        const req = await axios.get(`http://localhost:5000/product/id/${id}`);
        console.log(req)
        user.cart.products.push(req.data)
            ...
            <div className="container-fluid py-5">  
                <div className="row px-xl-5">
                        ...
                        <div id="product-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner border">
                                <div className="carousel-item active">
                                    <img className="w-100 h-100" src={data.imgUrl} alt="Image" />
                                </div>
                            </div>
                    ...
                    <div className="col-lg-7 pb-5">
                        ...
                        <h3 className="font-weight-semi-bold mb-4">&#8377;{data.price} <del>&#8377;{data.price + (data.price * (10 / 100))}</del></h3>
